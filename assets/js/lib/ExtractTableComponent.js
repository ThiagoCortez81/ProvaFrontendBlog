...
ExtractTableComponent.createTable = function() {
    this.table.html(`
        <div class="extract-table">
            <div class="row extract-table-header">
            ...
            <div class="row extract-table-sub-header">
                <div class="col-md-8">
            ...
            <div class="row row extract-table-sub-header">
                <div class="col-md-8">
...
ExtractTableComponent.fillTable = function( data ) {
    ...
    for (var i = 0; i < this.tableEntries.length; i++) {
        this.table.find(".entries-list").append(`
            <div class="row extract-table-row ${ (i + 1) % 2 == 0 ? "even-row" : "odd-row" }">
...
module.exports = ExtractTableComponent